...
namespace DutchTreat.Data.Migrations
{
    ...
    [Migration("20220207231856_ArtDescriptionNullable")]
    partial class ArtDescriptionNullable
    {
            ...
            modelBuilder.Entity("DutchTreat.Data.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            OrderDate = new DateTime(2022, 2, 7, 23, 18, 55, 949, DateTimeKind.Utc).AddTicks(285),
                            OrderNumber = "12345"
                        });
                });
